...
### **Project Structure**
```
├── login-standalone-with-otp.html   # Main login with risk assessment (1,714 lines)
├── face-auth-standalone.html        # Face recognition page (964 lines)
├── dashboard-standalone.html        # Password vault
├── settings-standalone.html         # User settings
├── config.js                        # API endpoint configuration
├── server/
│   ├── server.js                    # Node.js Express server
│   ├── routes/auth.js               # Authentication endpoints (1,062 lines)
...
### **Risk-Adaptive Authentication Classes** (900+ lines in login-standalone-with-otp.html)

1. **BehavioralBiometrics**: Captures keystroke timing without storing raw keystrokes
2. **DeviceRiskModule**: Browser fingerprinting using device characteristics
3. **BehaviorRiskModule**: Typing pattern analysis with baseline learning
4. **TimeRiskModule**: Temporal login pattern detection
5. **CredentialRiskModule**: Failed attempt tracking
6. **RiskAdaptiveAuth**: Risk aggregation with quorum logic
7. **ExplainableAuth**: Human-readable decision explanations
8. **AuthSimulator**: Testing utility for evaluation

### **Integration Points**
- ✅ Server already supports `challengeLevel` parameter (backward compatible)
- ✅ Face auth retrieves email from sessionStorage (context preservation)
- ✅ Both login flows (email/password + 2FA) include risk assessment
...
- [QUICK_SUMMARY.md](QUICK_SUMMARY.md) - Project overview (409 lines)
- [FEATURE_CHECKLIST.md](FEATURE_CHECKLIST.md) - All 34+ features (703 lines)

## 🎓 Academic Context

This project implements concepts from:
- **Behavioral Biometrics** (keystroke dynamics)
- **Risk-Adaptive Authentication** (dynamic MFA)
- **Zero-Knowledge Encryption** (AES-256, PBKDF2)
- **Explainable AI** (XAI for security decisions)
- **Privacy-Preserving Authentication** (client-side profiling)

## 📊 Project Statistics

- **Total Lines of Code**: 10,600+
- **Main Login File**: 1,714 lines (900+ for risk-adaptive framework)
- **Server Auth Routes**: 1,062 lines (16 endpoints)
- **Face Auth Page**: 964 lines
- **Documentation**: 1,500+ lines across 4 files
- **No Syntax Errors**: ✅ Verified
- **Production Ready**: ✅ Deployed on Hugging Face
...
💡 **Featured Implementation**: Privacy-preserving risk assessment with explainable AI
